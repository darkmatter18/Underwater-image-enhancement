...
def get_scheduler(optimizer, lr_policy, n_epochs, lr_decay_iters, epoch_count, n_epochs_decay):
    ...
    if lr_policy == 'linear':
        ...
        scheduler = lr_scheduler.LambdaLR(optimizer, lr_lambda=lambda_rule, verbose=True)
    elif lr_policy == 'step':
        scheduler = lr_scheduler.StepLR(optimizer, step_size=lr_decay_iters, gamma=0.1, verbose=True)
