...
def create_dataset(dataroot: str,  serial_batches: bool, preprocess: str, no_flip: bool, load_size: int,
    ...
    """
    dataset = UWIEDataset(dataroot=dataroot, serial_batches=serial_batches, preprocess=preprocess, flip=not no_flip,
