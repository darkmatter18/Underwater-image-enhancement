...
class UWIEDatasetTest(Dataset):
    ...
    def __init__(self, dataroot: str, subdir: str, phase: str, preprocess: str = 'RRC', load_size: int = 256,
                 crop_size: int = 224):
        """
        Custom Dataset for feeding Image to the network
        ...
        self.dir_A = os.path.join(self.dataroot, self.subdir, self.phase)  # create a path '/path/to/data/trainA'
